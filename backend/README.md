...
## Project Structure
    ...
    ├── taxation_template_38077  # Django project configurations
...
1. Clone this repo and `cd taxation_template_38077`
...
2. Clone this repo and `cd taxation_template_38077`
